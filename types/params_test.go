...
func TestConsensusParamsValidation(t *testing.T) {
	testCases := []struct {
		...
		// test block params
		0: {makeParams(1, 0, 2, 2, 0, valEd25519, 0), true},
		1: {makeParams(0, 0, 2, 2, 0, valEd25519, 0), false},
		2: {makeParams(47*1024*1024, 0, 2, 2, 0, valEd25519, 0), true},
		3: {makeParams(10, 0, 2, 2, 0, valEd25519, 0), true},
		4: {makeParams(100*1024*1024, 0, 2, 2, 0, valEd25519, 0), true},
		5: {makeParams(101*1024*1024, 0, 2, 2, 0, valEd25519, 0), false},
		6: {makeParams(1024*1024*1024, 0, 2, 2, 0, valEd25519, 0), false},
		7: {makeParams(47*1024*1024, 0, 0, 2, 0, valEd25519, 0), true},
		8: {makeParams(47*1024*1024, 0, -1, 2, 0, valEd25519, 0), false},

		// test evidence params
		9:  {makeParams(1, 0, 2, 0, 0, valEd25519, 0), false},
		10: {makeParams(1, 0, 2, 2, 2, valEd25519, 0), false},
		11: {makeParams(1000, 0, 2, 2, 1, valEd25519, 0), true},
		12: {makeParams(1, 0, 2, -1, 0, valEd25519, 0), false},
		// test no pubkey type provided
		13: {makeParams(1, 0, 2, 2, 0, []string{}, 0), false},
		// test invalid pubkey type provided
		14: {makeParams(1, 0, 2, 2, 0, []string{"potatoes make good pubkeys"}, 0), false},
		15: {makeParams(-1, 0, 2, 2, 0, valEd25519, 0), true},
		16: {makeParams(-2, 0, 2, 2, 0, valEd25519, 0), false},
	}
...
func TestConsensusParamsHash(t *testing.T) {
	params := []ConsensusParams{
		makeParams(4, 2, 2, 3, 1, valEd25519, 0),
		makeParams(1, 4, 2, 3, 1, valEd25519, 0),
		makeParams(1, 2, 2, 4, 1, valEd25519, 0),
		makeParams(2, 5, 2, 7, 1, valEd25519, 0),
		makeParams(1, 7, 2, 6, 1, valEd25519, 0),
		makeParams(9, 5, 2, 4, 1, valEd25519, 0),
		makeParams(7, 8, 2, 9, 1, valEd25519, 0),
		makeParams(4, 6, 2, 5, 1, valEd25519, 0),
	}
...
func TestConsensusParamsUpdate(t *testing.T) {
	testCases := []struct {
		...
		// fine updates
		{
			makeParams(1, 2, 25, 3, 0, valEd25519, 0),
			&cmtproto.ConsensusParams{
			...
			makeParams(100, 200, 250, 300, 50, valSecp256k1, 0),
		},
	}
...
func TestConsensusParamsUpdate_AppVersion(t *testing.T) {
	params := makeParams(1, 2, 25, 3, 0, valEd25519, 0)
...
func TestConsensusParamsUpdate_VoteExtensionsEnableHeight(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(*testing.T) {
			initialParams := makeParams(1, 0, 2, 2, 0, valEd25519, tc.from)
...
func TestProto(t *testing.T) {
	params := []ConsensusParams{
		makeParams(4, 2, 2, 3, 1, valEd25519, 1),
		makeParams(1, 4, 2, 3, 1, valEd25519, 1),
		makeParams(1, 2, 2, 4, 1, valEd25519, 1),
		makeParams(2, 5, 2, 7, 1, valEd25519, 1),
		makeParams(1, 7, 2, 6, 1, valEd25519, 1),
		makeParams(9, 5, 2, 4, 1, valEd25519, 1),
		makeParams(7, 8, 2, 9, 1, valEd25519, 1),
		makeParams(4, 6, 2, 5, 1, valEd25519, 1),
	}
